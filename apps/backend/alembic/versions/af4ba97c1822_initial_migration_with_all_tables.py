...
def upgrade() -> None:
    ...
    op.create_table(
        "devices",
        sa.Column(
            "id", postgresql.UUID(as_uuid=True), nullable=False, default=sa.func.gen_random_uuid()
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "cve_numbers", postgresql.ARRAY(sa.String()), nullable=True, default=sa.func.array([])
        ),
