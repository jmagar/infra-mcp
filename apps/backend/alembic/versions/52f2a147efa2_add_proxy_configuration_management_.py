...
def upgrade() -> None:
    ...
    op.add_column(
        "backup_status",
        sa.Column(
            "time", sa.DateTime(timezone=True), nullable=True, server_default=sa.text("now()")
        ),
    )
    ...
    op.add_column(
        "backup_status", sa.Column("backup_location", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "backup_status", sa.Column("backup_start_time", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "backup_status", sa.Column("backup_end_time", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "backup_status", sa.Column("backup_duration_seconds", sa.Integer(), nullable=True)
    )
    ...
    op.add_column(
        "backup_status", sa.Column("verification_status", sa.String(length=50), nullable=True)
    )
    op.add_column(
        "backup_status", sa.Column("verification_method", sa.String(length=100), nullable=True)
    )
    op.add_column("backup_status", sa.Column("checksum", sa.String(length=255), nullable=True))
    op.add_column(
        "backup_status", sa.Column("checksum_algorithm", sa.String(length=50), nullable=True)
    )
    op.add_column(
        "backup_status",
    ...
    op.add_column(
        "backup_status", sa.Column("archive_location", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "backup_status",
    ...
    op.execute(
        "UPDATE backup_status SET backup_id = 'backup_' || EXTRACT(EPOCH FROM COALESCE(time, NOW()))::text || '_' || device_id WHERE backup_id IS NULL"
    )
    op.alter_column(
        "backup_status", "backup_id", existing_type=sa.String(length=255), nullable=False
    )
    op.alter_column(
        "backup_status",
        "backup_type",
    ...
    op.drop_index(
        op.f("idx_backup_status_metadata"), table_name="backup_status", postgresql_using="gin"
    )
    ...
    op.add_column(
        "container_snapshots", sa.Column("memory_cache_bytes", sa.BigInteger(), nullable=True)
    )
    op.add_column(
        "container_snapshots", sa.Column("created_at", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "container_snapshots", sa.Column("started_at", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "container_snapshots", sa.Column("finished_at", sa.DateTime(timezone=True), nullable=True)
    )
    op.alter_column(
        "container_snapshots",
        "ports",
    ...
    op.drop_index(
        op.f("idx_container_snapshots_environment"),
        table_name="container_snapshots",
        postgresql_using="gin",
    )
    op.drop_index(
        op.f("idx_container_snapshots_labels"),
        table_name="container_snapshots",
        postgresql_using="gin",
    )
    ...
    op.alter_column(
        "devices", "id", existing_type=sa.UUID(), server_default=None, existing_nullable=False
    )
    op.alter_column("devices", "ip_address", existing_type=postgresql.INET(), nullable=False)
    op.alter_column(
        "devices",
        "device_type",
    ...
    op.alter_column(
        "devices", "ssh_port", existing_type=sa.INTEGER(), server_default=None, nullable=False
    )
    op.alter_column(
        "devices",
        "tags",
    ...
    op.add_column(
        "docker_networks",
        sa.Column("connected_containers", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    )
    op.add_column("docker_networks", sa.Column("container_count", sa.Integer(), nullable=True))
    op.add_column(
        "docker_networks",
        sa.Column("driver_options", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    )
    op.add_column(
        "docker_networks", sa.Column("created_at", sa.DateTime(timezone=True), nullable=True)
    )
    op.alter_column(
        "docker_networks",
        "time",
    ...
    op.drop_index(
        op.f("idx_docker_networks_labels"), table_name="docker_networks", postgresql_using="gin"
    )
    ...
    op.add_column(
        "drive_health", sa.Column("smart_overall_health", sa.String(length=50), nullable=True)
    )
    ...
    op.drop_index(
        op.f("idx_drive_health_smart_attrs"), table_name="drive_health", postgresql_using="gin"
    )
    ...
    op.add_column(
        "network_interfaces", sa.Column("carrier_state", sa.String(length=20), nullable=True)
    )
    ...
    op.add_column(
        "network_interfaces", sa.Column("wireless_ssid", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "network_interfaces", sa.Column("wireless_signal_strength", sa.Integer(), nullable=True)
    )
    op.add_column(
        "network_interfaces",
    ...
    op.add_column(
        "network_interfaces", sa.Column("bridge_id", sa.String(length=100), nullable=True)
    )
    op.add_column(
        "network_interfaces", sa.Column("bridge_stp_state", sa.String(length=20), nullable=True)
    )
    op.alter_column(
        "network_interfaces",
        "time",
    ...
    op.drop_index(
        op.f("idx_network_interfaces_ip_addresses"),
    ...
    op.add_column(
        "system_logs", sa.Column("first_occurrence", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "system_logs", sa.Column("last_occurrence", sa.DateTime(timezone=True), nullable=True)
    )
    ...
    op.execute(
        "UPDATE system_logs SET log_id = 'log_' || EXTRACT(EPOCH FROM time)::text || '_' || device_id WHERE log_id IS NULL"
    )
    op.alter_column("system_logs", "log_id", existing_type=sa.String(length=64), nullable=False)
    op.alter_column(
        "system_logs",
        "time",
        existing_type=postgresql.TIMESTAMP(timezone=True),
    ...
    op.drop_index(
        op.f("idx_system_logs_message_text"), table_name="system_logs", postgresql_using="gin"
    )
    op.drop_index(
        op.f("idx_system_logs_metadata"), table_name="system_logs", postgresql_using="gin"
    )
    ...
    op.add_column(
        "system_metrics", sa.Column("memory_cached_bytes", sa.BigInteger(), nullable=True)
    )
    op.add_column(
        "system_metrics", sa.Column("memory_buffers_bytes", sa.BigInteger(), nullable=True)
    )
    ...
    op.add_column(
        "system_metrics", sa.Column("disk_read_bytes_total", sa.BigInteger(), nullable=True)
    )
    op.add_column(
        "system_metrics", sa.Column("disk_write_bytes_total", sa.BigInteger(), nullable=True)
    )
    op.add_column(
        "system_metrics", sa.Column("disk_read_ops_total", sa.BigInteger(), nullable=True)
    )
    op.add_column(
        "system_metrics", sa.Column("disk_write_ops_total", sa.BigInteger(), nullable=True)
    )
    op.add_column(
        "system_metrics", sa.Column("network_bytes_sent_total", sa.BigInteger(), nullable=True)
    )
    op.add_column(
        "system_metrics", sa.Column("network_bytes_recv_total", sa.BigInteger(), nullable=True)
    )
    op.add_column(
        "system_metrics", sa.Column("network_packets_sent_total", sa.BigInteger(), nullable=True)
    )
    op.add_column(
        "system_metrics", sa.Column("network_packets_recv_total", sa.BigInteger(), nullable=True)
    )
    op.add_column(
        "system_metrics", sa.Column("network_errors_total", sa.BigInteger(), nullable=True)
    )
    ...
    op.add_column(
        "system_metrics", sa.Column("boot_time", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column("system_metrics", sa.Column("users_logged_in", sa.Integer(), nullable=True))
    op.drop_index(
        op.f("idx_system_metrics_additional"), table_name="system_metrics", postgresql_using="gin"
    )
    ...
    op.add_column(
        "system_updates", sa.Column("install_date", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "system_updates", sa.Column("install_duration_seconds", sa.Integer(), nullable=True)
    )
    op.add_column(
        "system_updates", sa.Column("download_size_bytes", sa.BigInteger(), nullable=True)
    )
    ...
    op.add_column(
        "system_updates", sa.Column("repository_url", sa.String(length=255), nullable=True)
    )
    ...
    op.add_column(
        "system_updates", sa.Column("checksum_algorithm", sa.String(length=50), nullable=True)
    )
    ...
    op.execute(
        "UPDATE system_updates SET update_id = 'update_' || EXTRACT(EPOCH FROM COALESCE(time, NOW()))::text || '_' || device_id WHERE update_id IS NULL"
    )
    op.alter_column(
        "system_updates",
        "time",
    ...
    op.alter_column(
        "system_updates", "update_id", existing_type=sa.String(length=255), nullable=False
    )
    op.alter_column(
        "system_updates", "package_type", existing_type=sa.VARCHAR(length=50), nullable=True
    )
    op.alter_column(
        "system_updates",
        "update_status",
    ...
    op.drop_index(
        op.f("idx_system_updates_metadata"), table_name="system_updates", postgresql_using="gin"
    )
    ...
    op.add_column(
        "vm_status", sa.Column("last_snapshot_time", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "vm_status",
    ...
    op.add_column(
        "zfs_snapshots", sa.Column("retention_policy", sa.String(length=100), nullable=True)
    )
    op.add_column(
        "zfs_snapshots",
        sa.Column("snapshot_properties", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    )
    op.add_column("zfs_snapshots", sa.Column("backup_status", sa.String(length=50), nullable=True))
    op.add_column(
        "zfs_snapshots", sa.Column("replication_status", sa.String(length=50), nullable=True)
    )
    op.add_column(
        "zfs_snapshots", sa.Column("last_backup_time", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "zfs_snapshots", sa.Column("backup_destination", sa.String(length=255), nullable=True)
    )
    ...
    op.drop_index(
        op.f("idx_zfs_snapshots_properties"), table_name="zfs_snapshots", postgresql_using="gin"
    )
    ...
    op.add_column(
        "zfs_status", sa.Column("scrub_start_time", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "zfs_status", sa.Column("scrub_end_time", sa.DateTime(timezone=True), nullable=True)
    )
    ...
    op.add_column(
        "zfs_status",
        sa.Column("pool_properties", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    )
    ...
    op.add_column(
        "zfs_status", sa.Column("dataset_available_bytes", sa.BigInteger(), nullable=True)
    )
    op.add_column(
        "zfs_status", sa.Column("dataset_referenced_bytes", sa.BigInteger(), nullable=True)
    )
    op.add_column(
        "zfs_status",
    ...
    op.add_column(
        "zfs_status",
        sa.Column("dataset_properties", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    )
    op.alter_column(
        "zfs_status",
        "time",
    ...
    op.drop_index(
        op.f("idx_zfs_status_properties"), table_name="zfs_status", postgresql_using="gin"
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "zfs_status", sa.Column("capacity_bytes", sa.BIGINT(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "zfs_status",
        sa.Column(
            "last_scrub", postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "zfs_status", sa.Column("free_bytes", sa.BIGINT(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "zfs_status",
        sa.Column(
    ...
    op.add_column(
        "zfs_status",
        sa.Column(
            "dedup_ratio", sa.NUMERIC(precision=6, scale=2), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "zfs_status",
    ...
    op.add_column(
        "zfs_status", sa.Column("allocated_bytes", sa.BIGINT(), autoincrement=False, nullable=True)
    )
    op.create_index(
        op.f("idx_zfs_status_time"), "zfs_status", [sa.literal_column("time DESC")], unique=False
    )
    op.create_index(op.f("idx_zfs_status_scrub_state"), "zfs_status", ["scrub_state"], unique=False)
    op.create_index(
        op.f("idx_zfs_status_properties"),
        "zfs_status",
        ["properties"],
        unique=False,
        postgresql_using="gin",
    ...
    op.create_index(
        op.f("idx_zfs_status_device_time"),
        "zfs_status",
        ["device_id", sa.literal_column("time DESC")],
        unique=False,
    )
    op.alter_column(
        "zfs_status",
    ...
    op.create_index(
        op.f("zfs_snapshots_time_idx"),
        "zfs_snapshots",
        [sa.literal_column("time DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_zfs_snapshots_properties"),
        "zfs_snapshots",
        ["properties"],
        unique=False,
        postgresql_using="gin",
    ...
    op.create_index(
        op.f("idx_zfs_snapshots_device_time"),
        "zfs_snapshots",
        ["device_id", sa.literal_column("time DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_zfs_snapshots_dataset"), "zfs_snapshots", ["dataset_name"], unique=False
    )
    op.create_index(
        op.f("idx_zfs_snapshots_creation_time"),
        "zfs_snapshots",
        [sa.literal_column("creation_time DESC")],
        unique=False,
    )
    op.alter_column(
        "zfs_snapshots",
    ...
    op.add_column(
        "vm_status", sa.Column("disk_usage_bytes", sa.BIGINT(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "vm_status", sa.Column("status", sa.VARCHAR(length=50), autoincrement=False, nullable=True)
    )
    op.add_column(
        "vm_status",
        sa.Column("network_bytes_sent", sa.BIGINT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "vm_status", sa.Column("memory_mb", sa.INTEGER(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "vm_status",
        sa.Column("network_bytes_recv", sa.BIGINT(), autoincrement=False, nullable=True),
    )
    ...
    op.create_index(
        op.f("idx_vm_status_time"), "vm_status", [sa.literal_column("time DESC")], unique=False
    )
    ...
    op.create_index(
        op.f("idx_vm_status_device_time"),
        "vm_status",
        ["device_id", sa.literal_column("time DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_vm_status_config"), "vm_status", ["config"], unique=False, postgresql_using="gin"
    )
    op.alter_column(
        "vm_status",
        "memory_usage_mb",
    ...
    op.create_index(
        op.f("idx_system_updates_update_status"), "system_updates", ["update_status"], unique=False
    )
    op.create_index(
        op.f("idx_system_updates_update_priority"),
        "system_updates",
        ["update_priority"],
        unique=False,
    )
    op.create_index(
        op.f("idx_system_updates_security_update"),
        "system_updates",
        ["security_update"],
        unique=False,
    )
    op.create_index(
        op.f("idx_system_updates_package_type"), "system_updates", ["package_type"], unique=False
    )
    op.create_index(
        op.f("idx_system_updates_package_name"), "system_updates", ["package_name"], unique=False
    )
    op.create_index(
        op.f("idx_system_updates_metadata"),
        "system_updates",
        ["metadata"],
        unique=False,
        postgresql_using="gin",
    ...
    op.create_index(
        op.f("idx_system_updates_last_checked"),
        "system_updates",
        [sa.literal_column("last_checked DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_system_updates_device_id"), "system_updates", ["device_id"], unique=False
    )
    op.alter_column(
        "system_updates",
        "update_status",
    ...
    op.alter_column(
        "system_updates", "package_type", existing_type=sa.VARCHAR(length=50), nullable=False
    )
    ...
    op.add_column(
        "system_metrics",
        sa.Column(
            "load_average_5m", sa.NUMERIC(precision=6, scale=2), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "system_metrics",
    ...
    op.add_column(
        "system_metrics",
        sa.Column(
            "load_average_1m", sa.NUMERIC(precision=6, scale=2), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "system_metrics",
    ...
    op.add_column(
        "system_metrics",
        sa.Column("disk_total_bytes", sa.BIGINT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "system_metrics",
        sa.Column(
            "load_average_15m", sa.NUMERIC(precision=6, scale=2), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "system_metrics",
    ...
    op.create_index(
        op.f("idx_system_metrics_time"),
        "system_metrics",
        [sa.literal_column("time DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_system_metrics_device_time"),
        "system_metrics",
        ["device_id", sa.literal_column("time DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_system_metrics_additional"),
        "system_metrics",
        ["additional_metrics"],
        unique=False,
        postgresql_using="gin",
    ...
    op.create_index(
        op.f("idx_system_logs_time"), "system_logs", [sa.literal_column("time DESC")], unique=False
    )
    op.create_index(op.f("idx_system_logs_source"), "system_logs", ["source"], unique=False)
    op.create_index(
        op.f("idx_system_logs_service_name"), "system_logs", ["service_name"], unique=False
    )
    op.create_index(op.f("idx_system_logs_process_id"), "system_logs", ["process_id"], unique=False)
    op.create_index(
        op.f("idx_system_logs_metadata"),
        "system_logs",
        ["metadata"],
        unique=False,
        postgresql_using="gin",
    ...
    op.create_index(
        op.f("idx_system_logs_message_text"),
        "system_logs",
        [sa.literal_column("to_tsvector('english'::regconfig, message)")],
        unique=False,
        postgresql_using="gin",
    )
    ...
    op.create_index(
        op.f("idx_system_logs_device_time"),
        "system_logs",
        ["device_id", sa.literal_column("time DESC")],
        unique=False,
    )
    ...
    op.add_column(
        "network_interfaces",
        sa.Column("tx_packets", sa.BIGINT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "network_interfaces",
        sa.Column("rx_packets", sa.BIGINT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "network_interfaces", sa.Column("tx_bytes", sa.BIGINT(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "network_interfaces",
        sa.Column("rx_dropped", sa.BIGINT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "network_interfaces",
    ...
    op.add_column(
        "network_interfaces",
        sa.Column("tx_dropped", sa.BIGINT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "network_interfaces",
        sa.Column("tx_errors", sa.BIGINT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "network_interfaces",
        sa.Column("rx_errors", sa.BIGINT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "network_interfaces", sa.Column("rx_bytes", sa.BIGINT(), autoincrement=False, nullable=True)
    )
    op.create_index(
        op.f("network_interfaces_time_idx"),
        "network_interfaces",
        [sa.literal_column("time DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_network_interfaces_state"), "network_interfaces", ["state"], unique=False
    )
    op.create_index(
        op.f("idx_network_interfaces_ip_addresses"),
        "network_interfaces",
    ...
    op.create_index(
        op.f("idx_network_interfaces_interface_type"),
        "network_interfaces",
        ["interface_type"],
        unique=False,
    )
    op.create_index(
        op.f("idx_network_interfaces_interface_name"),
        "network_interfaces",
        ["interface_name"],
        unique=False,
    )
    op.create_index(
        op.f("idx_network_interfaces_device_time"),
        "network_interfaces",
        ["device_id", sa.literal_column("time DESC")],
        unique=False,
    )
    ...
    op.add_column(
        "drive_health", sa.Column("capacity_bytes", sa.BIGINT(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "drive_health",
    ...
    op.add_column(
        "drive_health",
        sa.Column("uncorrectable_errors", sa.INTEGER(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "drive_health",
        sa.Column("total_lbas_read", sa.BIGINT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "drive_health",
        sa.Column(
    ...
    op.add_column(
        "drive_health",
        sa.Column("total_lbas_written", sa.BIGINT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "drive_health",
    ...
    op.add_column(
        "drive_health",
        sa.Column("pending_sectors", sa.INTEGER(), autoincrement=False, nullable=True),
    )
    op.create_index(
        op.f("idx_drive_health_time"),
        "drive_health",
        [sa.literal_column("time DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_drive_health_smart_status"), "drive_health", ["smart_status"], unique=False
    )
    op.create_index(
        op.f("idx_drive_health_smart_attrs"),
        "drive_health",
        ["smart_attributes"],
        unique=False,
        postgresql_using="gin",
    ...
    op.create_index(
        op.f("idx_drive_health_health_status"), "drive_health", ["health_status"], unique=False
    )
    op.create_index(
        op.f("idx_drive_health_drive_name"), "drive_health", ["drive_name"], unique=False
    )
    op.create_index(
        op.f("idx_drive_health_device_time"),
        "drive_health",
        ["device_id", sa.literal_column("time DESC")],
        unique=False,
    )
    ...
    op.create_index(
        op.f("idx_docker_networks_network_name"), "docker_networks", ["network_name"], unique=False
    )
    op.create_index(
        op.f("idx_docker_networks_network_id"), "docker_networks", ["network_id"], unique=False
    )
    op.create_index(
        op.f("idx_docker_networks_labels"),
        "docker_networks",
        ["labels"],
        unique=False,
        postgresql_using="gin",
    ...
    op.create_index(
        op.f("idx_docker_networks_device_time"),
        "docker_networks",
        ["device_id", sa.literal_column("time DESC")],
        unique=False,
    )
    op.create_index(
        op.f("docker_networks_time_idx"),
        "docker_networks",
        [sa.literal_column("time DESC")],
        unique=False,
    )
    ...
    op.add_column(
        "devices", sa.Column("description", sa.TEXT(), autoincrement=False, nullable=True)
    )
    op.drop_index(op.f("ix_devices_ip_address"), table_name="devices")
    op.drop_index(op.f("ix_devices_hostname"), table_name="devices")
    op.create_index(
        op.f("idx_devices_tags"), "devices", ["tags"], unique=False, postgresql_using="gin"
    )
    op.create_index(op.f("idx_devices_status"), "devices", ["status"], unique=False)
    op.create_index(
        op.f("idx_devices_monitoring_enabled"), "devices", ["monitoring_enabled"], unique=False
    )
    ...
    op.create_unique_constraint(
        op.f("devices_hostname_key"), "devices", ["hostname"], postgresql_nulls_not_distinct=False
    )
    op.alter_column(
        "devices",
        "updated_at",
    ...
    op.alter_column("devices", "ip_address", existing_type=postgresql.INET(), nullable=True)
    op.alter_column(
        "devices",
        "id",
    ...
    op.create_index(
        op.f("idx_container_snapshots_time"),
        "container_snapshots",
        [sa.literal_column("time DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_container_snapshots_status"), "container_snapshots", ["status"], unique=False
    )
    op.create_index(
        op.f("idx_container_snapshots_state"), "container_snapshots", ["state"], unique=False
    )
    op.create_index(
        op.f("idx_container_snapshots_labels"),
        "container_snapshots",
    ...
    op.create_index(
        op.f("idx_container_snapshots_device_time"),
        "container_snapshots",
        ["device_id", sa.literal_column("time DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_container_snapshots_container_name"),
        "container_snapshots",
        ["container_name"],
        unique=False,
    )
    op.create_index(
        op.f("idx_container_snapshots_container_id"),
        "container_snapshots",
        ["container_id"],
        unique=False,
    )
    ...
    op.add_column(
        "backup_status", sa.Column("files_count", sa.BIGINT(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "backup_status",
        sa.Column(
    ...
    op.add_column(
        "backup_status", sa.Column("size_bytes", sa.BIGINT(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "backup_status",
        sa.Column(
    ...
    op.add_column(
        "backup_status",
        sa.Column("compressed_size_bytes", sa.BIGINT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "backup_status", sa.Column("error_message", sa.TEXT(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "backup_status",
        sa.Column(
    ...
    op.add_column(
        "backup_status", sa.Column("success_count", sa.BIGINT(), autoincrement=False, nullable=True)
    )
    op.create_index(op.f("idx_backup_status_status"), "backup_status", ["status"], unique=False)
    op.create_index(
        op.f("idx_backup_status_start_time"),
        "backup_status",
        [sa.literal_column("start_time DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_backup_status_metadata"),
        "backup_status",
        ["metadata"],
        unique=False,
        postgresql_using="gin",
    ...
    op.create_index(
        op.f("idx_backup_status_end_time"),
        "backup_status",
        [sa.literal_column("end_time DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_backup_status_device_id"), "backup_status", ["device_id"], unique=False
    )
    op.create_index(
        op.f("idx_backup_status_created_at"),
        "backup_status",
        [sa.literal_column("created_at DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_backup_status_backup_type"), "backup_status", ["backup_type"], unique=False
    )
    op.alter_column(
        "backup_status",
        "warning_count",
