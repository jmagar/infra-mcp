...
class SSHSettings(BaseSettings):
    ...
    ssh_connect_timeout: int = Field(default=10, env="SSH_CONNECT_TIMEOUT")  # Alias for compatibility
...
class RetentionSettings(BaseSettings):
    ...
    retention_container_snapshots_days: int = Field(default=30, env="RETENTION_CONTAINER_SNAPSHOTS_DAYS")
