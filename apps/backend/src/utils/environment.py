...
WSL_DETECTION_COMMAND = "grep -q microsoft /proc/version 2>/dev/null && echo 'WSL' || echo 'NOT_WSL'"
CONTAINER_DETECTION_COMMAND = "[ -f /.dockerenv ] && echo 'CONTAINER' || echo 'NOT_CONTAINER'"
SYSTEMD_DETECTION_COMMAND = "systemctl is-system-running >/dev/null 2>&1 && echo 'SYSTEMD' || echo 'NOT_SYSTEMD'"
...
class EnvironmentDetector:
    ...
    @staticmethod 
    def is_container_environment(dockerenv_exists: bool = None, proc_cgroup_content: str = None) -> bool:
        """
