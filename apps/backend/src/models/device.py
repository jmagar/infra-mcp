...
class Device(Base):
    ...
    device_type = Column(String(50), default="server", index=True)  # server, container_host, storage, network
    ...
    status = Column(String(20), default="unknown", index=True)  # online, offline, unknown, maintenance
