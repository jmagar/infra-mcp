...
async def get_zfs_pools_resource(uri: str) -> str:
    ...
    try:
        ...
        if pool_name:
            ...
            return json.dumps(
                {"resource_type": "zfs_pools", "hostname": hostname, "pools": data, "uri": uri},
                indent=2,
                ensure_ascii=False,
            )
        ...
        return json.dumps({"error": str(e), "uri": uri, "resource_type": "zfs_pools"}, indent=2)
...
async def get_zfs_datasets_resource(uri: str) -> str:
    ...
    try:
        ...
        return json.dumps({"error": str(e), "uri": uri, "resource_type": "zfs_datasets"}, indent=2)
...
async def get_zfs_snapshots_resource(uri: str) -> str:
    ...
    try:
        ...
        return json.dumps({"error": str(e), "uri": uri, "resource_type": "zfs_snapshots"}, indent=2)
...
async def get_zfs_health_resource(uri: str) -> str:
    ...
    try:
        ...
        return json.dumps(
            {"resource_type": "zfs_health", "hostname": hostname, "health": data, "uri": uri},
            indent=2,
        )
...
async def get_zfs_resource(uri: str) -> str:
    ...
    try:
        ...
        return json.dumps({"error": str(e), "uri": uri, "resource_type": "zfs_unknown"}, indent=2)
