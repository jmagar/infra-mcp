...
async def _make_api_request(endpoint: str, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
...
async def get_system_logs_resource(uri: str) -> str:
    ...
    try:
        ...
        return json.dumps({
            ...
            "metadata": {
                "execution_time": data.get('execution_time') if isinstance(data, dict) else None,
        ...
        return json.dumps({
            ...
            "metadata": {
                ...
                "container_info": {
                    ...
                    "container_name": data.get('container_name') if isinstance(data, dict) else container_name
                }
            },
            "uri": uri
        }, indent=2, default=str, ensure_ascii=False)
...
async def get_logs_resource(uri: str) -> str:
    ...
    try:
        ...
        return json.dumps({
            "error": str(e),
            "uri": uri,
            "resource_type": "logs_routing_error"
        }, indent=2, ensure_ascii=False)