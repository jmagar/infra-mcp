...
from apps.backend.src.services.device_service import get_device_by_hostname as svc_get_device_by_hostname
...
"""
    ...
    async def _scan_system_ports(self, device: str, start_port: int, end_port: int, result: PortScanResult) -> None:
        """Scan system ports using netstat."""
        try:
    ...
    async def _scan_docker_ports(self, device: str, result: PortScanResult) -> None:
    ...
    async def _map_containers_to_networks(self, device: str, result: NetworkScanResult) -> None:
    ...
    def _suggest_recommended_network(self, networks: list[dict[str, Any]]) -> str | None:
    ...
    async def _create_deployment_directories(self, device: str, deployment_path: str, result: ComposeDeploymentResult) -> None:
    ...
    async def _backup_existing_compose(self, device: str, deployment_path: str, result: ComposeDeploymentResult) -> None:
    ...
    async def _write_compose_file(self, device: str, deployment_path: str, content: str, result: ComposeDeploymentResult) -> None:
    ...
    async def _stop_services(self, device: str, deployment_path: str, services: list[str], result: ComposeDeploymentResult) -> None:
    ...
    async def _pull_images(self, device: str, deployment_path: str, result: ComposeDeploymentResult) -> None:
    ...
    async def _start_services(self, device: str, deployment_path: str, services: list[str], recreate: bool, result: ComposeDeploymentResult) -> None:
    ...
    async def _get_service_status(self, device: str, deployment_path: str, result: ComposeDeploymentResult) -> None:
