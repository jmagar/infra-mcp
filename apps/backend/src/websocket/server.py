...
from .message_protocol import (
    MessageType, WebSocketMessage, SubscriptionMessage, HeartbeatMessage, 
    AuthMessage, create_error_message
)
            ...
            try:
                ...
                if message_type == MessageType.SUBSCRIPTION:
                    ...
                    try:
                        ...
                        logger.debug(f"Failed to send subscription confirmation to {client_id}: {e}")
                        break
