...
def upgrade() -> None:
    ...
    op.create_table('container_snapshots',
        ...
        sa.Column('ports', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('[]' :: sa.text())),
        sa.Column('environment', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        sa.Column('labels', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        sa.Column('volumes', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('[]' :: sa.text())),
        sa.Column('networks', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('[]' :: sa.text())),
    ...
    op.create_table('zfs_status',
        ...
        sa.Column('feature_flags', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        sa.Column('pool_properties', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        ...
        sa.Column('dataset_properties', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        sa.ForeignKeyConstraint(['device_id'], ['devices.id'], ondelete='CASCADE'),
    ...
    op.create_table('zfs_snapshots',
        ...
        sa.Column('snapshot_properties', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
    ...
    op.create_table('network_interfaces',
        ...
        sa.Column('ip_addresses', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('[]' :: sa.text())),
        sa.Column('mac_address', postgresql.MACADDR(), nullable=True),
    ...
    op.create_table('docker_networks',
        ...
        sa.Column('connected_containers', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('[]' :: sa.text())),
        sa.Column('container_count', sa.Integer(), nullable=True, default=0),
        sa.Column('driver_options', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        sa.Column('labels', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(['device_id'], ['devices.id'], ondelete='CASCADE'),
    ...
    op.create_table('vm_status',
        ...
        sa.Column('network_interfaces', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('[]' :: sa.text())),
        sa.Column('ip_addresses', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('[]' :: sa.text())),
        ...
        sa.Column('vm_metadata', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        sa.Column('tags', postgresql.ARRAY(sa.String()), nullable=True, default=sa.func.array([])),
        sa.ForeignKeyConstraint(['device_id'], ['devices.id'], ondelete='CASCADE'),
    ...
    op.create_table('system_logs',
        ...
        sa.Column('parsed_fields', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        ...
        sa.Column('log_metadata', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        sa.Column('tags', postgresql.ARRAY(sa.String()), nullable=True, default=sa.func.array([])),
        sa.ForeignKeyConstraint(['device_id'], ['devices.id'], ondelete='CASCADE'),
    ...
    op.create_table('backup_status',
        ...
        sa.Column('error_messages', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('[]' :: sa.text())),
        ...
        sa.Column('backup_metadata', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        sa.Column('backup_config', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        sa.Column('tags', postgresql.ARRAY(sa.String()), nullable=True, default=sa.func.array([])),
        sa.ForeignKeyConstraint(['device_id'], ['devices.id'], ondelete='CASCADE'),
    ...
    op.create_table('system_updates',
        ...
        sa.Column('dependencies', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('[]' :: sa.text())),
        ...
        sa.Column('update_metadata', postgresql.JSONB(astext_type=sa.Text()), nullable=True, default=sa.func.jsonb('{}' :: sa.text())),
        sa.Column('tags', postgresql.ARRAY(sa.String()), nullable=True, default=sa.func.array([])),
        sa.ForeignKeyConstraint(['device_id'], ['devices.id'], ondelete='CASCADE'),
