"""Add proxy configuration management tables
...
def upgrade() -> None:
    ...
    op.add_column('backup_status', sa.Column('time', sa.DateTime(timezone=True), nullable=False))
    op.add_column('backup_status', sa.Column('backup_id', sa.String(length=255), nullable=False))
    ...
    op.add_column('devices', sa.Column('ssh_user', sa.String(length=100), nullable=True))
    ...
    op.add_column('system_logs', sa.Column('log_id', sa.String(length=64), nullable=False))
    ...
    op.add_column('system_updates', sa.Column('time', sa.DateTime(timezone=True), nullable=False))
    op.add_column('system_updates', sa.Column('update_id', sa.String(length=255), nullable=False))
...
def downgrade() -> None:
    ...
    op.add_column('devices', sa.Column('ssh_username', sa.VARCHAR(length=100), server_default=sa.text("'root'::character varying"), autoincrement=False, nullable=True))
    ...
    op.drop_column('devices', 'ssh_user')
